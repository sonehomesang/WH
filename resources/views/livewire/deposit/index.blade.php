...
<div class="pb-6">
    ...
    <style>.deposit-list thead th { box-shadow: inset 0 -2px 0 #cbd5e1; }</style>
    <div class="max-w-[1536px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {{-- total deposit count → teleported up into the app header top bar --}}
        <template x-teleport="#page-header-slot">
            <span class="hidden lg:inline-flex items-baseline gap-1.5 ml-2 px-2.5 py-1 rounded-lg bg-white/70 border border-white/70 shadow-sm">
                ...
                <span class="text-xs text-gray-500 whitespace-nowrap">ໃບຝາກ ທັງໝົດ</span>
            </span>
        </template>
        ...
        <div class="hidden md:block bg-white border border-gray-200 rounded-xl shadow-sm">
            <table class="wh-list deposit-list w-full text-sm table-fixed">
                    <colgroup>
